			...
			switch (LOWORD (wparam))
			{
				...
				*/
				case IDC_PING_START:
				{
					...
					{
						_r_sys_createthread (NULL, NtCurrentProcess (), &_app_tool_ping, hwnd, NULL, L"Ping");
					}
				...
				case IDC_SPEEDMETER_START:
				{
					...
					{
						_r_sys_createthread (NULL, NtCurrentProcess (), &_app_tool_downloadspeed, hwnd, NULL, L"DownloadSpeed");
					}
				...
				{
					_r_sys_createthread (NULL, NtCurrentProcess (), &_app_tool_urlinfo, hwnd, NULL, L"UrlInfo");
					break;
				}
				...
				{
					_r_sys_createthread (NULL, NtCurrentProcess (), &_app_tool_whois, hwnd, NULL, L"Whois");
					break;
				}
